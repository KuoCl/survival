...
<body>
	...
	<div class="container-fluid page-header py-5 mb-5 wow fadeIn"
		...
		<div class="container text-center py-5">
			<h1
				class="display-3 text-white text-uppercase mb-3 animated slideInDown">貼文修改</h1>
	...
	<div class="container-xxl py-5">
		<div class="container">
			<div class="text-center mx-auto mb-5 wow fadeInUp"
				data-wow-delay="0.1s">
				<p class="d-inline-block bg-secondary text-primary py-1 px-4">貼文修改</p>
				<h1 class="text-uppercase">貼文修改</h1>
			</div>
			<!-- class="row" 橫向排列-->
			<div class="text-center mx-auto mb-5 wow fadeInUp">
